...
<html lang="es">
    ...
    <body>
      ...
      <form method="post" name="combo" action="../registrar/registrarreporte.php"   >
         ...
         <div> <select name="cbx_indicador" id="cbx_indicador" required >
             <option value = "0" disabled selected> Seleccione Indicador</ option>
         </select></div>
         <input type="text" id="fec" name="fec" placeholder="Fecha" required>
         <input type="text" id="val" name="val" placeholder="Valor" required>
